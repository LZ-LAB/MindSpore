...
__all__ = ["save", "load", "load_state_dict", "arange", "cat", "cos", "clamp", "Device", "from_numpy", "flatten",
           ...
           'Size', 'DoubleTensor', 'cosine_similarity', 'x2ms_any',
           ...
           'heaviside', 'histogram', 'histogramdd', 'hypot', 'inner', 'kron', 'lcm', 'logaddexp', 'logaddexp2',
           'nanmean', 'swapaxes', 'dstack']
...
from .torch_api.torch_base_api import arange, cat, cos, clamp, Device, from_numpy, flatten, \
    ...
    DoubleTensor, cosine_similarity, x2ms_any, greater, greater_equal, \
    ...
    deg2rad, diff, gcd, heaviside, histogram, histogramdd, hypot, inner, kron, lcm, logaddexp, logaddexp2, nanmean, \
    swapaxes, dstack
